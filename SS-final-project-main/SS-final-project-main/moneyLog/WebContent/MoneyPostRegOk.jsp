		...
		<div class="row sign-up-form mt-3">
         <div class="sign-up-process col-12" style="margin-top: 25%;">
               ...
               <div class="text-center mt-3">
                  <button type="button" class="btn btn-primary mb-3" style="width: 200px; background-color: #1fa766;" onclick="newPage()"> 내 <b>게시글</b> 확인하기 </button>
                  <br>
                  <button type="button" class="btn btn-primary mb-3" style="width: 200px; background-color: #1fa766;" onclick="newPage2()"> 내 <b>가게부</b>로 돌아가기 </button>
               </div>
