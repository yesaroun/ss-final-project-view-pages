				...
				<div class="row">
						<table id="cont" class="table2 col-12">
						     ...
						     <tr>    
						         <th>내용</th>
						         <td>
						         	<textarea name="content" rows="10" cols="60" readonly="readonly">로그인을 안하면 아무것도 할 수 없나요?</textarea>
						     	</td>    
						     </tr>
						</table>
				</div>
					...
					<div class="row" >
						...
						<div class="col-8" style="margin-top: 20px;" >
							<div class="input-group">
								   <input type="text" class="form-control" style="height: 70px; border: 1px solid;" placeholder="내용을 입력해주세요." readonly="readonly">
							</div>
						</div><!-- /.col-sm-8 -->
