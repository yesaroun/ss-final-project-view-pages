				...
				<div class="row">
						<table id="cont" class="table2 col-12">
						     ...
						     <tr>    
						         <th>제목</th>
						         <td>
						         	<input type="text" style="padding-left:15px; width: 500px; height:35px;" placeholder="제목을 입력해주세요.">
						         </td>
						     </tr>  
						     <tr>    
						         <th>내용</th>
						         <td>
						         	<textarea name="content" rows="10" cols="60" placeholder="내용을 입력해주세요." style="padding-left: 12px;"></textarea>
						     	</td>    
						     </tr>
						</table>
				</div>
