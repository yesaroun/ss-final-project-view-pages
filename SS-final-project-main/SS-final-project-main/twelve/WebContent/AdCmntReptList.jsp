				...
				<div class="row">
					<div class="col-sm-9">
						<div class="btn-group float-left">
							<button type="submit" class="btn btn-primary" style="width:100px; background-color: #9b9b9b;" onclick="newPage()">게시글 신고</button>
							<button type="submit" class="btn btn-primary" style="width:100px; background-color: #1fa766;">댓글 신고</button>
						</div>
					</div>
				</div>
			</div>
