							...
							<div class="input-group">
								   <input type="text" class="form-control" style="height: 70px; border: 1px solid;" placeholder="내용을 입력해주세요.">
								      <span class="input-group-btn">
											<button class="btn btn-default" type="button" style="background-color: lightgray; color: white;" onclick="qnaAnswer()">답변</button>
											<button class="btn btn-default" type="button" style="background-color: skyblue; color: white;" onclick="javascript:location.href='<%=cp%>/AdQnaUpdate.jsp'"> 수정</button>
											<button class="btn btn-default" type="button" style="background-color: #1fa766; color: white;" onclick="javascript:location.href='<%=cp%>/AdQnaList.jsp'">목록</button>
								      </span>
							</div>
						</div><!-- /.col-sm-8 -->
