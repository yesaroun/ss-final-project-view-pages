...
<script type="text/javascript">
	...
	{
		confirm("신고가 완료되었습니다.");
		window.location.href = "http://localhost:8090/WEB/UserPostList.jsp"; // 링크수정
	}
		...
		<div class="container">
				...
				<div class="row">
						<div class="col-12" style="margin-top: 20px;">
							<button type="reset" class="btn btn-primary" style="background-color: #1fa766; float: right; padding-left: 10px;" onclick="javascript:location.href='<%=cp%>/UserPostList.jsp'">취소하기</button>
