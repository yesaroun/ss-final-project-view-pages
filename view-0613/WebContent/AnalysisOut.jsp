						...
						<div class="row">
							<div class="col-sm-12">
								<div class="btn-group float-left">
									...
									<button type="button" class="btn btn-dark" onclick="newPage3()"> 수입 </button>
									<button type="button" class="btn btn-success" onclick="newPage4()"> 지출 </button>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="list-group">
								<br><br>
								<h4> 지출 <small> [ 김태형 ] 님의 [ 5월 ] 지출 분석 </small> </h4>
						...
						<div class="col-md-12">
							<div class="list-group">
								<br><br>
								<h4> 지출 <small> [ 김태형 ] 님의 [ 5월 ] 지출 리스트 (수정해야함) </small> </h4>
