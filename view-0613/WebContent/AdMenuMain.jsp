        ...
        <nav class="col-md-2 float-left col-1 pl-0 pr-0 collapse width show" id="sidebar" style="position: fixed; top: 58px;">
            <div class="list-group border-0 card text-center text-md-left">
                ...
                <div class="collapse" id="admanage">
                    <a href="#" class="list-group-item" data-parent="#sidebar">회원 목록</a>
                    <a href="#" class="list-group-item" data-parent="#sidebar">영구정지회원</a>
                    <a href="#" class="list-group-item" data-parent="#sidebar">신고처리</a>
                </div>
                ...
                <div class="collapse" id="moneyreview">
                    <a href="AdMenuMain.jsp" class="list-group-item" data-parent="#sidebar">게시글 목록</a>
                    <a href="AdMenuMain.jsp" class="list-group-item" data-parent="#sidebar">댓글 목록</a>
                </div>
                ...
                <div class="collapse" id="cs">
                    ...
                    <a href="#" class="list-group-item" data-parent="#sidebar">문의글</a>
                </div>
