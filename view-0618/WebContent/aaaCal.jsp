...
<%
   ...
   double pigCount = Math.round(((result1+result2)/(double)60)/2*100);
...
<script type="text/javascript">
   ...
   {
      window.location.href = "./moneypostreg.action";
   }
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-6" style="text-align: right;">
            ...
            <fmt:formatNumber value="${nowRemain }" groupingUsed="true"></fmt:formatNumber> 원
         </div>
      </div>
            ...
            <div class="list-group">
               ...
               <div class="progress" style="background-color: white;">
                  ...
                  <div
                     ...
                     role="progressbar" 
                     style="/*width: <%=pigCount-5%>%;*/ width: 30%;"
      ...
      <div class="row">
         <div class="col-11">
            ...
            <div class="list-group">
               <!-- 머니리뷰 프로그레스바 -->
               <div class="progress"
                  style="height: 40px; background-color: #1fa766;">

                  <div
                     class="progress-bar progress-bar bg-warning progress-bar-animated"
                     role="progressbar" style="font-size: 17pt; 
                     /* width: <%=pigCount%>%; */
                     width: 30%;"
                     aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                     <%-- <%=pigCount%>% --%>
         ...
         <div class="col-1" style="place-items: left; display: grid;">
            <button type="submit" class="btn btn-primary"
               style="background-color: #1fa766; height: 40px;"
               data-toggle="modal" data-target="#modal">리뷰하기</button>
         </div>
      </div>
      <div class="row mt-3">
         <div class="col-12">
            <button type="submit" class="btn btn-primary" style="background-color: #1fa766; width: 100%;" onclick="moveAnalysis()">
               이번달 분석하기
            </button>
         </div>
      </div>
