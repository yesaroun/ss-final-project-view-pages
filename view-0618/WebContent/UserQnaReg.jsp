		...
		<div class="container">
				<div class="row">
						<table id="cont" class="table2 col-12">
						     <tr>
						         <th>제목</th><!-- value 확인 -->
						      	 <td>
						      	 	<input type="text" value="" style="padding-left:15px; width: 500px; height:35px;">
						      	 <td>
						     <tr>    
						         <th>작성자</th>
						         <td>
				...
				<div class="row">
						<div class="col-12" style="margin-top: 20px;">
							...
							<button type="reset" class="btn btn-secondary" style="background-color: #1fa766; float: right;" onclick="javascript:location.href='<%=cp%>/UserQnaList.jsp'">취소하기</button>
						</div>
				</div>
		</div>
	</div>				
