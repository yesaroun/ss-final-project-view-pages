...
<script type="text/javascript">
	function newPage()
	{
	  window.location.href = "./leaveOk.jsp"
	}
						...
						<div class="list-group-item">
							<div class="list-group">
								<form action="">
	            					...
	            					<input type="checkbox" id="a"> <label for="a"> 안내 사항을 모두 확인하였으며, 이에 동의합니다.</label>
	            					<br><br>
	            					
									<button type="button" class="btn btn-primary" id="login-btn" style="width:100%; background-color: #1fa766;"
									data-toggle="modal" data-target="#modal"> 탈퇴하기 </button>
								</form>
							</div>
						</div>
					</div>
				...
				<div class="modal-body">
					<form>
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary" onclick="newPage()">탈퇴하기</button>
						</div>
